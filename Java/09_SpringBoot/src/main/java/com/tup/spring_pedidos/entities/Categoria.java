...
public class Categoria extends Base {
    ...
    // TP JPA
    @OneToMany(fetch = FetchType.LAZY) // categoria conoce sus productos pero producto no tiene atributo categoria
    @JoinColumn(name = "categoria_id") //  entidad propietaria, fk categoria_id esta en productos
    @Builder.Default
    // inicializo el set
